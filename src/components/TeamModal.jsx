...
const TeamModal = ({ teamId, teamName, allPlayers, onClose, onPlayerClick, onTeamClick }) => {
  ...
  const getDisplayName = (player) => {
    ...
    return fullName.length <= 10 ? fullName : player.web_name;
  };
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-3 sm:px-6 py-3 sm:py-4">
